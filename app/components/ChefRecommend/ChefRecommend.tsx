      ...
      <div className="md:w-1/2 w-full flex flex-col items-center text-center justify-center mb-8 md:mb-0">
        <div className="rounded-2xl overflow-hidden shadow-lg border-4 border-[var(--accent)] max-w-xs mb-10">
          <Image
            width={500}
            height={500}
            src="/images/photo-1547573854-74d2a71d0826.webp"
        ...
        <button className="rounded-md text-black drop-shadow-md bg-[var(--logo-green)] font-semibold px-8 py-3 text-lg shadow-md hover:bg-yellow-400 transition-colors [text-shadow:_1px_1px_2px_rgb(0_0_0_/_20%)]">
          اكتشف المزيد
        </button>
      </div>
      {/* Food Photo */}
      <div className="md:w-1/2 w-full flex justify-center z-10"></div>
      <div className="my-6">
        <svg
          width="120"
          height="20"
