...
export default function CustomerReviews() {
  return (
    ...
    >
      <h2 className="text-3xl font-bold mb-10 text-[var(--accent)] text-center font-[var(--font-cairo)] [text-shadow:_1px_1px_3px_rgb(0_0_0_/_25%)]">
        آراء العملاء
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {reviews.map((item, idx) => (
          ...
          >
            ...
            <h3 className="font-bold text-white mb-2 font-[var(--font-cairo)] [text-shadow:_1px_1px_2px_rgb(0_0_0_/_30%)]">
              {item.name}
            </h3>
