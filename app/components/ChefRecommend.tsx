...
export default function ChefRecommend() {
  return (
    <section className="w-full flex flex-col md:flex-row items-center justify-center py-20 px-6 md:px-0 gap-12 bg-[var(--logo-white)]">
      {/* Text Content */}
      <div className="md:w-1/2 w-full flex flex-col items-center text-center justify-center mb-8 md:mb-0">
        ...
        <p className="text-base md:text-lg text-black/80 mb-8 mr-6 max-w-md font-[var(--font-cairo)] text-right">
